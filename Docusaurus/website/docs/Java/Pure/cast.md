...
- 一方のオペランドがdouble型である場合、演算前に他方のオペランドはdouble型に変換される
- 一方のオペランドがfloat型であり、他方のオペランドがdouble型でない場合、演算前に他方のオペランドはfloat型に変換される
- 一方のオペランドがlong型であり、他方のオペランドがdouble、float型でない場合、演算前に他方のオペランドはlong型に変換される
- 両方のオペランドがlong型、float型、double型のいずれでもない場合、演算前に双方のオペランドはint型に変換される
...
なお、全てのオブジェクトはObjectクラスを基底とするため、Object型の変数で扱えることになる。
